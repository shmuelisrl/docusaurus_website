...
export function DocSearchModal(_ref) {
  ...
  var searchClient = useSearchClient(typesenseServerConfig, transformSearchClient);
  ...
  }, [typesenseCollectionName, typesenseSearchParameters, searchClient, onClose, recentSearches, favoriteSearches, saveRecentSearch, initialQuery, placeholder, navigator, transformItems, disableUserPersonalization]);
